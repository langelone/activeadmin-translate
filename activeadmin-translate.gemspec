...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.md".freeze, "CONTRIBUTING.md".freeze, "LICENSE".freeze, "README.md".freeze, "app/assets/stylesheets/active_admin/translate.css.scss".freeze, "config/locales/ca.yml".freeze, "config/locales/de.yml".freeze, "config/locales/en.yml".freeze, "config/locales/es.yml".freeze, "config/locales/fr.yml".freeze, "config/locales/it.yml".freeze, "lib/active_admin".freeze, "lib/active_admin/translate".freeze, "lib/active_admin/translate/engine.rb".freeze, "lib/active_admin/translate/form_builder.rb".freeze, "lib/active_admin/translate/version.rb".freeze, "lib/active_admin/views".freeze, "lib/active_admin/views/translate_attributes_table.rb".freeze, "lib/activeadmin-translate.rb".freeze]
